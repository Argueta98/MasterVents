<div class="form-group mb-3">
    ...
    <div>
        {{ Form::text('category', old('category'), ['class' => 'form-control' . ($errors->has('category') ? ' is-invalid' : ''), 'placeholder' => 'Category']) }}
...
<div class="form-group mb-3">
    ...
    <div>
        {{ Form::select('status', ['1' => 'Activo', '0' => 'Inactivo'], old('status'), ['class' => 'form-control' . ($errors->has('status') ? ' is-invalid' : ''), 'placeholder' => 'Select Status']) }}
